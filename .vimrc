...
" tabnew -> gt; tabprev -> gT
" function! tabedit(arg)
"     tabnew a:arg<CR>
" endfunction
" command! -nargs=1 Te call tabedit(<f-args>)
...
" Easy way to exit from Terminal mode to Normal mode
tnoremap <Esc> <C-\><C-n>
...
" Don't close window, when deleting a buffer -- Needs REDESIGN
