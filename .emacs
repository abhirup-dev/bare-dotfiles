...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (which-key use-package gruvbox-theme poet-theme parchment-theme evil-org spacemacs-theme dracula-theme helm evil-visual-mark-mode))))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
...
;; (set-frame-font "DejaVu Sans Mono-14" nil t) ; FIXME: startup error
(set-face-font 'default "Source Code Pro Medium-12")

(show-paren-mode 1) ; Highlights matching parentheses
>>>>>>> 2d255fbfc2c6cb9b5e2bead3757919eb25ba78dd
